...
/* package KnapsackGA-0.1.0.0 */
#ifndef VERSION_KnapsackGA
#define VERSION_KnapsackGA "0.1.0.0"
#endif /* VERSION_KnapsackGA */
#ifndef MIN_VERSION_KnapsackGA
#define MIN_VERSION_KnapsackGA(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_KnapsackGA */
...
#define CURRENT_COMPONENT_ID "KnapsackGA-0.1.0.0-IkPuPTH1LIELUsAhp9zOrB-KnapsackGA"
